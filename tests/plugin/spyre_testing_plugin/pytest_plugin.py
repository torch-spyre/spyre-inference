...
from spyre_testing_plugin.upstream import (
    apply_temp_upstream_code_edits,
    prepare_upstream_tests_dir,
)
...
def pytest_configure(config):
    ...
    if tests_dir.is_dir() and vllm_pkg.is_dir():
        ...
        try:
            # Clone vLLM to cache
            upstream_tests_base = prepare_upstream_tests_dir(repo_root, log=_log)
            apply_temp_upstream_code_edits(upstream_tests_base)
